...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2023 at 11:45 PM
...
CREATE TABLE `category` (
  ...
  `category_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `type` tinyint(4) NOT NULL,
  `image` longtext CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `contest_questions` (
  ...
  `optione` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
INSERT INTO `languages` (`id`, `language`, `status`, `date_created`) VALUES
(2, 'english', 1, '2023-07-02 21:23:38');
...
CREATE TABLE `question` (
  ...
  `optionc` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `optiond` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `optione` text CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
(3, 'system_configurations', '{\"system_configurations\":\"1\",\"system_configurations_id\":\"3\",\"system_timezone_gmt\":\"+05:30\",\"system_timezone\":\"Asia/Colombo\",\"app_link\":\"https://www.linkedin.com/in/hirunika-siriwardane-9a3322214?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAADYnGQsBmWQ65BdMROUBhel0rskAW7pQHbQ&lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3B0MfcgDtaQJWRe20Ftsgu1Q%3D%3D\",\"more_apps\":\"https://www.linkedin.com/in/hirunika-siriwardane-9a3322214?miniProfileUrn=urn%3Ali%3Afs_miniProfile%3AACoAADYnGQsBmWQ65BdMROUBhel0rskAW7pQHbQ&lipi=urn%3Ali%3Apage%3Ad_flagship3_feed%3B0MfcgDtaQJWRe20Ftsgu1Q%3D%3D\",\"ios_app_link\":\"\",\"ios_more_apps\":\"\",\"refer_coin\":\"50\",\"earn_coin\":\"100\",\"reward_coin\":\"4\",\"welcome_coin\":\"50\",\"app_version\":\"1.0\",\"true_value\":\"True\",\"false_value\":\"False\",\"answer_mode\":\"1\",\"language_mode\":\"1\",\"option_e_mode\":\"1\",\"force_update\":\"0\",\"daily_quiz_mode\":\"1\",\"contest_mode\":\"1\",\"battle_random_category_mode\":\"0\",\"battle_group_category_mode\":\"0\",\"in_app_purchase_mode\":\"1\",\"learning_zone_mode\":\"1\",\"maths_quiz_mode\":\"1\",\"true_false_mode\":\"1\",\"spin_mode\":\"0\",\"fix_question\":\"1\",\"total_question\":\"10\",\"app_maintenance\":\"1\",\"app_maintenance_message\":\"Apologies for the inconvenience! Our app is undergoing scheduled maintenance to enhance performance. We appreciate your patience.\",\"shareapp_text\":\"Discover [Quiz App Name], the ultimate quiz experience! Get it now on Play Store and challenge your knowledge. Enjoy\",\"in_app_ads_mode\":\"0\",\"ads_type\":\"1\",\"adAppId\":\"test\",\"admob_Rewarded_Video_Ads\":\"test\",\"admob_interstitial_id\":\"test\",\"admob_banner_id\":\"test\",\"native_unit_id\":\"test\",\"admob_openads_id\":\"test\",\"fb_interstitial_id\":\"\",\"fb_banner_id\":\"\",\"fb_rewarded_video_ads\":\"\",\"fb_native_unit_id\":\"\",\"ios_in_app_ads_mode\":\"0\",\"ios_ads_type\":\"1\",\"ios_admob_Rewarded_Video_Ads\":\"iostest\",\"ios_admob_interstitial_id\":\"iostest\",\"ios_admob_banner_id\":\"iostest\",\"ios_admob_openads_id\":\"iostest\",\"ios_fb_interstitial_id\":\"\",\"ios_fb_banner_id\":\"\",\"ios_fb_rewarded_video_ads\":\"\",\"instagram_link\":\"http://demo.com\",\"facebook_link\":\"http://demo.com\",\"youtube_link\":\"http://demo.com\"}', 1),
...
CREATE TABLE `subcategory` (
  ...
  `language_id` tinyint(4) NOT NULL DEFAULT 0,
  `subcategory_name` varchar(250) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `tbl_fcm_key` (
  `id` int(11) NOT NULL,
  `fcm_key` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
CREATE TABLE `users` (
  ...
  `ip_address` char(128) NOT NULL DEFAULT '',
...
--
-- Table structure for table `user_purchased_category`
--

CREATE TABLE `user_purchased_category` (
  `id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `is_Purchased` tinyint(1) DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indexes for table `user_purchased_category`
--
ALTER TABLE `user_purchased_category`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `user_purchased_category`
--
ALTER TABLE `user_purchased_category`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
